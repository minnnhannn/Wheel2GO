...
$all_after=array();
	...
	//$bicycle:每台車的分項分數
$bicycle=array(0=>array(5,10,5,4,4),1=>array(5,5,5,5,6),2=>array(3,5,5,3,4),3=>array(4,2,5,2,3));
...
echo "<tr>";
echo "<td>扭力:".$row['topspeed']."</td>";
echo "</tr>";

echo "<tr>";
echo "<td>動力型式:".$row['cost']."</td>";
echo "</tr>";

echo "<tr>";
echo "<td>引擎:".$row['company']."</td>";
echo "</tr>";
